Railsgenerator::Application.routes.draw do

  # root 'generator#create_project'

  # post 'projects' => 'generator#make_project'
  ...
  #   # mount Something::Engine, at: "something"
      mount Object.const_get(f.name.camelize)::Engine => f.name.downcase
  ...
  post '/create_app' => 'session#create_app'
